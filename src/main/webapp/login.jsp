  ...
  <div class=" tab-pane fade show active  " id="pills-login" role="tabpanel" aria-labelledby="tab-login">
    <form action="login" method="post">
      ...
      <div class="form-outline mb-4">
        <input type="text" name="user" id="loginName" class="form-control" />
...
<h3 style="color: red;">${error}</h3>
      ...
      <!-- Username input -->
      <div class="form-outline mb-4">
        <input type="text" name="user" id="registerUsername" class="form-control" />
        <label class="form-label" for="registerUsername">Username</label>
      </div>

      <!-- Email input -->
      <div class="form-outline mb-4">
        <input type="email" name="mail" id="registerEmail" class="form-control" />
      ...
      <div class="form-outline mb-4">
        <input type="password" name="confirm" id="registerRepeatPassword" class="form-control" />
